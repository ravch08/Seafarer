...
export { default as aboutBanner } from "../../assets/banner-about.jpg";
export { default as contactBanner } from "../../assets/banner-contact.jpg";
export { default as tourBanner } from "../../assets/banner-tour.jpg";
export { default as banner } from "../../assets/banner.jpg";
export { default as bgBanner1 } from "../../assets/bg-banner-01.jpg";
export { default as bgBanner2 } from "../../assets/bg-banner-02.jpg";
...
export { default as TourBooking } from "../sections/TourBooking.tsx";
export { default as TourDescription } from "../sections/TourDescription.tsx";
export { default as TourPlan } from "../sections/TourPlan.tsx";
export { default as TourReviews } from "../sections/TourReviews.tsx";
